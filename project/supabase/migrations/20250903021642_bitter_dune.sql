/*
  ...
  2. Views
    - `stripe_user_subscriptions` - Join customers and subscriptions for user access
    - `stripe_user_orders` - Join customers and orders for user access

  3. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to access their own data
    - Views are security definer to allow proper joins
*/
